  ...
  <div class="login-wrap">
      <el-form class="login-container">
        ...
        <!-- <el-form-item label="验证码：">
          <el-image :src="imgUrl"/>
          <el-input type="text" v-model="verifyCode" placeholder="验证码" autocomplete="off"></el-input>
        </el-form-item> -->
        <el-form-item>
...
export default{
  ...
  data () {
      return {
        ...
        password:'admin123',
        verifyCode: '',
        imgUrl: "https://image.baidu.com/search/detail?ct=503316480&z=0&tn=baiduimagedetail&ipn=d&cl=2&cm=1&sc=0&lm=-1&ie=gb18030&pn=2&rn=1&di=7169026086108397569&ln=30&word=%CD%BC%C6%AC&os=1580975018,2245152236&cs=1177878058,928882326&objurl=http%3A%2F%2Flmg.jj20.com%2Fup%2Fallimg%2F1114%2F041621122252%2F210416122252-1-1200.jpg&bdtype=0&simid=1177878058,928882326&pi=0&adpicid=0&timingneed=&spn=0&is=0,0&fr=ala&ala=1&alatpl=normal&pos=1&oriquery=%E5%9B%BE%E7%89%87&dyTabStr=MCwzLDYsMSw0LDIsNSw3LDgsOQ%3D%3D"
      }
    },
  methods:{
      async doLogin(){
