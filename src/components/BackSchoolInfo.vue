  ...
  <div>
    ...
    <el-row>
      ...
      <el-row >
        ...
        <el-col :span="20">
          <input type="text" v-model="BSInfo.departPlace"  placeholder="出发地" autocomplete="off">
        </el-col>
        <el-col :span="4">出发时间:</el-col>
        <el-col :span="20">
          <input type="text" v-model="BSInfo.departTime"  placeholder="出发时间" autocomplete="off">
        </el-col>
        <el-col :span="4">目的地:</el-col>
        <el-col :span="20">
          <input type="text" v-model="BSInfo.destination"  placeholder="目的地" autocomplete="off">
        </el-col>
        <el-col :span="4">出行方式:</el-col>
        <el-col :span="20">
          <input type="text" v-model="BSInfo.transportMode"  placeholder="出行方式" autocomplete="off">
        </el-col>
        ...
        <el-col :span="20">
          <input type="text" v-model="BSInfo.temperature"  placeholder="体温" autocomplete="off">
        </el-col>
      </el-row>
...
import {getBackSchoolInfo, addBackSchoolInfo, deleteBackSchoolInfo} from '@/api/index'
